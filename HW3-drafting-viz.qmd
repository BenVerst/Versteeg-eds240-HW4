...
2.  Overarching question: How has trends in gaming changed globaly between years 1980 and 2016?
...
ggplot(global_sales, aes(x = year, y = global_sales)) +  # Specifies data and aesthetics for the plot
  ...
  ggtitle("Number of Global Sales From 1980 to 2016") +  # Adds plot title
...
ggplot(genre_distribution_2008, aes(x = "", y = genre_proportion, fill = genre)) +  # Create a pie chart
  ...
  labs(title = "Genre Popularity in 2008") +  # Add plot title
...
ggplot(top_publisher_sales, mapping = aes(x = year, y = global_sales)) +
  ...
  ggtitle("Global Sales of Game Publishers From 1980 to 2016") +
